    ...
    <div className="homepage">
          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Loream Ipsum dolor sit amet consectetur adisipicing elit.
                Loream Ipsum dolor sit amet consectetur adisipicing elit.
              </p>
      ...
      <div className="kelas w-100 min-vh-100">
        <Container>
          <Row>
            <Col>
            <h1 className="text-center fw-bold " data-aos-duration="1000" data-aos-delay="100">Kelas Terbaru</h1>
            <p className="text-center " data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">Loream Ipsum dolor sit amet consectetur adisipicing elit.</p>
            </Col>
          </Row>
          <Row>
          ...
          <Row>
            <Col className="text-center" data-aos="fade-right" data-aos-duration="1000">
